...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
	...
	return (
		<div className="fixed inset-0 z-50 flex transform items-center justify-center overflow-y-auto overflow-x-hidden bg-black/80 transition-transform duration-300">
			<div className="relative mx-auto w-auto max-w-3xl overflow-hidden rounded-md">
				...
				>
					<div className="relative h-96">
						...
						<button
							onClick={handleClose}
							className="absolute right-3 top-3 flex h-10 w-10 items-center justify-center rounded-full bg-black/70"
						>
