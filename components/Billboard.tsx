			...
			<div className="absolute top-[30%] ml-4 md:top-[40%] md:ml-16">
				...
				<div className="mt-3 flex flex-row items-center gap-3 md:mt-4">
					...
					<button
						...
						className="flex w-auto flex-row items-center rounded-md bg-white bg-opacity-30 px-2 py-1 text-xs font-semibold text-white transition-colors hover:bg-opacity-20 md:px-4 md:py-2 lg:text-lg"
					>
